...
filtro = Filtro(_senal=potencia_dB, # senal a filtrar
                ...
                _frec_corte=2, # Frecuencia de corte en unidades de T_muestreo
...
senal_filtrada = filtro.filtrar_por_ventana_de_hanning()
"""
==============================================================================
...
lambda_mejorada = np.arange(1510-n_zeros*T_muestreo_lambda, 
                    1590 + n_zeros*T_muestreo_lambda, # quiando +0.001
                    T_muestreo_lambda) 
